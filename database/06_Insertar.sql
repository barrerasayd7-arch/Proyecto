...
INSERT INTO usuarios
    (telefono, password_hash, nombre, descripcion, correo, id_rol, universidad)
VALUES
...
VALUES
    ...
    (1, 13),
    (13, 1),
    -- Sayd y Julian (Bases de Datos)
    (13, 11),
    (11, 13),
    -- Julian y Nicolas
    (15, 1),
    (1, 15),
    -- Diego y Sayd (IA y Sistemas)
    (17, 3),
    (3, 17),
    -- Felipe y Camilo
    ...
    (8, 10),
    (10, 8),
    -- Paula (Psicología) y Gabriela (Idiomas)
    (10, 12),
    (12, 10),
    -- Gabriela e Isabella (Admin)
    (18, 8),
    (8, 18),
    -- Lucía (Socio) y Paula
    (14, 17),
    (17, 14),
    -- Elena (Ambiental) y Felipe

    -- Seguimientos aleatorios por servicios (clientes siguiendo a proveedores)
    (5, 1),
    -- Andrés sigue a Sayd (por Desarrollo Web)
    (7, 2),
    -- Mateo sigue a Lenin (por Tutoría Cálculo)
    (9, 4),
    -- Santiago sigue a Valentina (por Derecho)
    (12, 17),
    -- Isabella sigue a Felipe (por Arriendo)
    (16, 3),
    -- Sara sigue a Camilo (por SQL)
    (6, 11),
    -- Mariana sigue a Nicolas (por Flutter)
    (2, 15),
    -- Lenin sigue a Diego (por IA)
    (4, 9);
-- Valentina sigue a Santiago (por Diseño)
...
VALUES
    ...
    (3, 11, 3, 1),
    -- Camilo solicita App Móvil a Nicolas
    (11, 1, 1, 1),
    -- Nicolas solicita React a Sayd
    (15, 13, 4, 1),
    -- Diego solicita Debug Java a Julian
    (1, 3, 1, 1),
    -- Sayd solicita SQL a Camilo
    (17, 4, 2, 0),
    -- Felipe solicita Python a Valentina (Pendiente)

    -- Solicitudes de Tutorías
    (5, 2, 2, 1),
    -- Andrés solicita Cálculo a Lenin
    (8, 10, 7, 1),
    -- Paula solicita Inglés a Gabriela
    (16, 5, 5, 0),
    -- Sara solicita Álgebra a Andrés (Pendiente)
    (10, 16, 8, 1),
    -- Gabriela solicita Microeconomía a Sara
    (2, 15, 9, 0),
    -- Lenin solicita Física a Diego (Pendiente)

    -- Solicitudes de Redacción y Diseño
    (18, 2, 10, 1),
    -- Lucía solicita Normas APA a Lenin
    (12, 18, 11, 1),-- Isabella solicita Ensayos a Lucía
    (9, 4, 18, 1),
    -- Santiago solicita Diapositivas a Valentina
    (4, 9, 16, 0),
    -- Valentina solicita Logo a Santiago (Pendiente)
    (7, 1, 17, 1),
    -- Mateo solicita Edición Video a Sayd

    -- Solicitudes de Arriendo (Categoría 6)
    (5, 17, 19, 1),
    -- Andrés solicita Habitación a Felipe
    (10, 12, 20, 0),
    -- Gabriela solicita Aparto-estudio a Isabella (Pendiente)
    (14, 5, 21, 1),
    -- Elena solicita Cupo a Andrés

    -- Otros Servicios (Varios)
    (1, 10, 23, 1),
    -- Sayd solicita Almuerzo a Gabriela
    (3, 8, 24, 0),
    -- Camilo solicita Nutrición a Paula (Pendiente)
    (6, 15, 25, 1),
    -- Mariana solicita Reparación Celular a Diego
    (13, 6, 26, 1),
    -- Julian solicita Accesorios a Mariana
    (11, 13, 27, 0),
    -- Nicolas solicita Formateo a Julian (Pendiente)
    (8, 11, 28, 1),
    -- Paula solicita Fotografía a Nicolas
    (12, 3, 22, 1),
    -- Isabella solicita Mantenimiento PC a Camilo
    (7, 10, 23, 1),
    -- Mateo solicita Almuerzo a Gabriela
    (18, 12, 12, 1),
    -- Lucía solicita Traducción a Isabella
    (4, 1, 1, 1);
-- Valentina solicita React a Sayd
