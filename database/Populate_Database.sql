...
-- =============================================
-- Lenin destaca la "Puntualidad" (tipo_aspecto = 0)
-- Recordatorio: Esta tabla acepta múltiples inserts para el mismo id_calificacion
INSERT INTO aspectos_destacados (id_calificacion, tipo_aspecto)
VALUES (1, 0); 

-- Si quisiera agregar también "Calidad", solo harías otro insert:
-- INSERT INTO aspectos_destacados (id_calificacion, tipo_aspecto) VALUES (1, 1);
