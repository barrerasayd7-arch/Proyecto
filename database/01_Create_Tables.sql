...
(
    ...
    -- 1 Bloqueado, 0 No bloqueado
    fecha_registro DATETIME2 DEFAULT GETDATE(),
    id_rol INT NOT NULL DEFAULT 2,
    -- 1 Admin, 2 Usuario común
...
(
    ...
    -- Uso de MAX para descripciones largas
    id_categoria INT,
    precio_hora DECIMAL(10, 2) NOT NULL,
    contacto NVARCHAR(150),
    modalidad INT,
    -- 0: Presencial, 1: Virtual, 2: Mixta
    icono NVARCHAR(10),
    disponibilidad INT,
    -- 0: Entre semana, 1: Fines, 2: Siempre
...
(
    ...
    -- Vincula la reseña a una transacción real
    id_cliente INT NOT NULL,
    -- Quién califica
    id_servicio INT NOT NULL,
    -- Qué servicio califica
